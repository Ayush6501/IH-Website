...
let arr = [
  {
    ...
    Desc: "Intricate technical topics which are related to engineering fields are introduced, taught and explored under a stipulated time by leading industry experts. Some of our technical workshops include :CNN and Artificial Intelligence,Stock market prediction using AI/ML,Git and Github Webinar,Animatia: Workshop on Animation and Designing",
    Img:"/assets/images/events/1.png"
  },
  {
    Number: 1,
    Title: "Non-Technical Workshops",
    Desc: "Workshops fostering creativity, lateral thinking and promoting social causes are also conducted by us. Some of our major ventures include :Take a chance day: The event took up the challenge of encouraging people to take that first important step towards every task to bring about changes right from the roots.Colloquium: The event focused on how to make the most of one’s college experience by offering them a comprehensive overview of the four years of college alongside the much needed career do’s and don'ts.",
    Img:"/assets/images/events/2.png"
  },
  {
    Number: 2,
    Title: "Competitions:",
    Desc: "The “RIP” competition is organized for the first-year students participating in the 'Rural Immersion Program' of MIT. They are asked to list the main challenges faced by the people of the area and plausible solutions for the same. Winners are given prizes and an opportunity to develop a project with the club.We are planning more platforms like annual hackathons and coding contests for everyone to be able to showcase their skills. Stay tuned on our social media for more updates!",
